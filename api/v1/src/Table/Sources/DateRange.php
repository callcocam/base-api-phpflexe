...
trait DateRange
{
     ...
     */
    public function scopeCurrentMinute($query,$number = 0)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopelastMinute($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeCurrentHour($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeLastHour($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeCurrentDay($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeLastDay($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeCurrentWeek($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeLastWeek($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeCurrentMonth($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeLastMonth($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeCurrentYear($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeLastYear($query,$number = 0)
    {
        return $query->whereBetween('created_at', [
